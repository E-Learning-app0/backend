# Database migration for Vimeo integration
# Run this SQL against your PostgreSQL database to add the new columns
...
print("Run the above SQL commands in your PostgreSQL database to add Vimeo support")
print("Or use Alembic for proper database migrations")
